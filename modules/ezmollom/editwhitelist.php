<?php
// File containing the logic of editwhitelist view
...
{
    $Module->redirectTo( $Module->functionURI( "whitelist" ) );
    return;
}
...
if ( $http->hasPostVariable( "StoreButton" ) )
{
    ...
    $entry = $mollom->savewhitelistEntry( $params );	
...
if ( !isset( $entry ) )
	$entry = $mollom->getwhitelistEntry($ID);
...
$Result['path'] = array(
    ...
    array( 'url' => 'ezmollom/whitelist', 'text' => ezpI18n::tr( 'fumaggo/design/ezmollom/whitelist', 'Whitelist' ) ),
    array( 'url' => false, 'text' => ezpI18n::tr( 'fumaggo/design/ezmollom/whitelist', 'Edit whitelist entry' ) )
);

$Result['content'] = $tpl->fetch( 'design:editwhitelist.tpl' );
